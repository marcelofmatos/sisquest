 ...
 * metabase_mysql.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/metabase/metabase_mysql.php,v 1.82 2006/07/08 22:45:49 mlemos Exp $
 *
 */
...
class metabase_mysql_class extends metabase_database_class
{
	...
	Function CommitTransaction()
	{
		...
		if($this->auto_commit)
			return($this->SetError("Commit transaction","transaction changes are already being auto commited"));
	...
	Function EscapePatternText($text)
	{
		...
		return(str_replace("_", "\\_", str_replace("%", "\\%", $text)));
	}
