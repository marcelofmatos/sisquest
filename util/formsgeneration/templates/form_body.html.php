...
<td ><?php echo (IsSet($verify["administrator_subscription"]) ? "[Verify]" : ""); ?></td>
</tr>
...
<tr>
<td colspan="3" align="center"><?php $form->AddInputPart("image_subscribe"); ?> <?php $form->AddInputPart("button_subscribe"); $form->AddInputPart("doit"); ?></td>
</tr>
<?php
	}
?>
